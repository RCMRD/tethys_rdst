...
def app(request):
    """
        Controller for the app page
        :param request:
        :return:
    """
    # latest dekadal wms
    geoserver_engine = mapp.get_spatial_dataset_service(name='main_geoserver', as_engine=True)
    dekadal_lyrs = []
    ...
    return render(request, 'rdst/map.html', context)
